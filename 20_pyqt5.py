...
# Form implementation generated from reading ui file 'text_box.ui'
#
...
from Windowtext import Ui_SecondWindow
import time
...
class Ui_MainWindow(object):
    ...
    def pressed(self):
        ...
        self.thing = self.textEdit.toPlainText()
        # Assign thing to second window
        self.ui.label.setText(f"{time.time()-t1}")
